...
```{r}
#| label: setup
library(tidyverse, include.only = "")
...
query.ls <- 
  list(
           ...
           set2_terms = 
            c( "open science", "opening science", "open sciences", "opened science", "science 2.0" , "open evaluation", "open review", "open peer review", "open metrics", "open methods", "open methodology", "open method", "pre-registration", "opening data",  "FAIR data", "open scientific software" 
            ),
             NOT_terms = c(),
           FROM_date = as.Date("2019-01-1"),
           UNTIL_date = as.Date("2025-8-30"),
           MAX_results = 10000
           )
```
